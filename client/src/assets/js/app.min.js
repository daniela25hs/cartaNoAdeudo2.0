...
var handleAlertFlash = function(){
    $('.system-messages div.alert').delay(5000).fadeOut(500);
};

var handleAjaxSetuoCSRF = function(){
...
var handlePreventDeleteButton = function () {
